...
public class MusicTrack extends Node {
	...
	public static MusicTrack readTrack(Index var0, int var1, int var2) {
		byte[] var3 = Objects.requireNonNull(Objects.requireNonNull(var0.archive(var1)).file(var2)).getData(); // L: 16
	...
	public static MusicTrack readTrackFromString(Index var0, String var1) {
		byte[] var3 = Objects.requireNonNull(Objects.requireNonNull(var0.archive(var1)).file(0)).getData();
