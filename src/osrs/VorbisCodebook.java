...
public class VorbisCodebook {
	...
	VorbisCodebook() {
		...
		if (var1) { // L: 27
			...
			for (var3 = VorbisSample.readBits(5) + 1; var2 < this.entries; ++var3) { // L: 29 30 33
				int var4 = VorbisSample.readBits(ByteBufferUtils.iLog(this.entries - var2)); // L: 31
	...
	static int mapType1QuantValues(int var0, int var1) {
		int var2;
		for (var2 = (int)Math.pow((double)var0, 1.0D / (double)var1) + 1; ByteBufferUtils.method5852(var2, var1) > var0; --var2) { // L: 16 17
		}
