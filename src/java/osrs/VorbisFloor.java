...
public class VorbisFloor {
	...
	void vorbisFloorSort(int var1, int var2) {
		if (var1 < var2) { // L: 83
			int var3 = var1; // L: 84
			...
			this.vorbisFloorSort(var1, var3 - 1); // L: 103
			this.vorbisFloorSort(var3 + 1, var2); // L: 104
		}
	} // L: 105
	...
	boolean readSubmapFloor() {
		...
		if (!var1) { // L: 154
			...
			int var4 = ByteBufferUtils.iLog(var3 - 1); // L: 158
	...
	void method692(float[] var1, int var2) {
		...
		this.vorbisFloorSort(0, var3 - 1); // L: 210
		var6 = 0; // L: 211
