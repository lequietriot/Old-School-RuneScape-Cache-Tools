...
public class MidiFixerRSHD {
	...
	final static String patch29 = "Overdrive Guitar";
	...
	final static String patch129 = "Gong Hits"; // Custom Percussion
	...
	final static String patch178 = "Ethnic Drum Kit"; // Custom Percussion
	final static String patch179 = "Imperial Drum Kit"; // Custom Percussion
	final static String patch184 = "Special Effects Drum Kit";
	final static String patch255 = "Standard Drum Kit";
	
	final static String patch256 = "Choir Aahs";
	final static String patch257 = "Warm Pad"; // This patch is transposed up 12 notes.
	final static String patch258 = "Pizzicato Strings";
	final static String patch259 = "Bass Drum"; // This patch is transposed down 12 notes.
	final static String patch260 = "Shakuhachi"; // This patch is transposed up 12 notes.
	final static String patch261 = "Strings";
	final static String patch262 = "Slow Strings";
	final static String patch263 = "Acoustic Grand Piano";
	final static String patch264 = "Strings";
	final static String patch265 = "Pan Flute"; // This patch is transposed down 12 notes.
	final static String patch266 = "Choir Aahs";
	...
	public static byte[] returnFixedMIDI(byte[] midiData) throws InvalidMidiDataException, IOException {
